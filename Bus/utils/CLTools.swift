...
//  CLTools.swift
//
//  Created by cleven on 2017/10/16.
//  Copyright © 2017年 cleven. All rights reserved.
//

import UIKit

class CLTools: NSObject {
    
    
    //单例创建
    static let shareTool : CLTools = {
        let Tool = CLTools()
    ...
    func sizeWithFont(font : UIFont, width : CGFloat, text : String) -> CGSize {
        ...
        return text.boundingRect(with: size, options: .usesLineFragmentOrigin, attributes: attrs as? [NSAttributedStringKey : Any], context: nil).size
    }
